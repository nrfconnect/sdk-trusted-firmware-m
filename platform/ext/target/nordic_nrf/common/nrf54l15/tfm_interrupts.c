...
static struct irq_t gpiote20_0_irq = {0};

void GPIOTE20_0_IRQHandler(void)
{
    spm_handle_interrupt(gpiote20_0_irq.p_pt, gpiote20_0_irq.p_ildi);
}

enum tfm_hal_status_t tfm_gpiote20_0_irq_init(void *p_pt,
                                         const struct irq_load_info_t *p_ildi)
{
    return irq_init(&gpiote20_0_irq, TFM_GPIOTE20_0_IRQ, p_pt, p_ildi);
}
...
static struct irq_t gpiote30_0_irq = {0};

void GPIOTE30_0_IRQHandler(void)
{
    spm_handle_interrupt(gpiote30_0_irq.p_pt, gpiote30_0_irq.p_ildi);
}

enum tfm_hal_status_t tfm_gpiote30_0_irq_init(void *p_pt,
                                         const struct irq_load_info_t *p_ildi)
{
    return irq_init(&gpiote30_0_irq, TFM_GPIOTE30_0_IRQ, p_pt, p_ildi);
}
