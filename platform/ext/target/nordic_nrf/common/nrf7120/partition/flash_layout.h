...
/* nRF7120 has 4088 kB of non volatile memory (MRAM) but the last 96kB are reserved
...
#define FLASH_TOTAL_SIZE                    (0x3E1000)         /* 3972 kB since the last 166kB are reserved for FLPR */
 ...
 * RAM_03: 124 Kb - FLPR code and data
...
#define TOTAL_RAM_SIZE                      (0x00080000)       /* 512 kB, since other 508 kB are reserved for others */
