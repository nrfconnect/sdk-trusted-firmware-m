...
enum tfm_plat_err_t spu_init_cfg(void)
{
    ...
    spu_regions_flash_config(S_CODE_START, S_CODE_START + S_CODE_SIZE - 1, SPU_SECURE_ATTR_SECURE,
    ...
    spu_regions_sram_config(S_DATA_START, S_DATA_START + S_DATA_SIZE - 1, SPU_SECURE_ATTR_SECURE,
			    perm, SPU_LOCK_CONF_LOCKED);
