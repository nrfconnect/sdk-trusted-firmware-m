                                                      ...
                                                      size_t nonce_size)
{
    ...
    tfm_memcpy(nonce, g_enc_nonce_seed, sizeof(g_enc_nonce_seed));
    tfm_memcpy(nonce + sizeof(g_enc_nonce_seed),
               &g_enc_counter,
               sizeof(g_enc_counter));
